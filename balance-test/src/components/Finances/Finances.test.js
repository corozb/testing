...
describe('rendering components', () => {
  it('renders App components without chasing', () => {
    shallow(<App />)
  })

  it('renders App component header without chasing', () => {
  ...
  it('renders Notificacion component without crashing', () => {
